...
namespace CRM.AppWebMVC.Controllers
{
    public class CustomerController : Controller
    {
        ...
        //Constructor que recive una instancia de ihttpclientfactory para crear el cliente http
        ...
        public async Task<IActionResult> Index(SearchQueryCustomerDTO searchQueryCustomerDTO, int CountRow = 0)
        {
            ...
            //realizar una sulicitud http post para buscar clientes en el servico web
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            //realiza una solicitud http get para obtener los detalles del cliente por Id
        ...
        //metodo para procesar la cracion de un cliente
        [HttpPost]
        ...
        public async Task<IActionResult> Delete(int id, GetIdResultCustomerDTO getIdResultCustomerDTO)
        {
            try 
            {
                //realizar una solicitud hhtp delete para eliminar el cliente por id
